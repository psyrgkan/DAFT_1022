...
# I am using a dictionary of words to ints and words to operations
number_dict = {
    'zero': 0,
    'one': 1,
    'two': 2,
...
# Instead of checking each word check if in dictionary otherwise print error
if (a not in number_dict and b not in operation_dict and c not in number_dict):
    print("""I am not able to answer this question. Check your input. Errors: \n
    ___________________________________________________________________________""")

# Process them as numbers and print the result
print("%s %s %s equals %d" % (a, b, c, operation_dict[b](number_dict[a], number_dict[c])))
